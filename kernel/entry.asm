...
STRING_GOODBYE: db "Shutting down!", 0
STRING_DOUBLEFAULT: db "DOUBLE FAULT!!!", 0
STRING_EXCEPTION: db "EXCEPTION", 0
STRING_IRQ: db "IRQ", 0
STRING_PS2FAIL: db "PS/2 SELF TEST FAILED!", 0
